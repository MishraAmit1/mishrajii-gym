...
if (isset($_GET['id'])) {
  $id = $_GET['id'];
  $query = "SELECT * FROM gym_basic_plan WHERE id='$id'";
...
if (isset($_POST['update_plan'])) {
  ...
  $sql = "UPDATE gym_basic_plan SET price='$price', months='$months', selectservices='$services' WHERE id='$id'";
  if (mysqli_query($conn, $sql)) {
    header("Location: basic_plan_display.php");
  } else {
